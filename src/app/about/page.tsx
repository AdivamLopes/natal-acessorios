...
export const metadata = {
    title: 'Sobre Nós - Natal Acessórios',
    description: 'Conheça a história da Natal Acessórios, uma marca inspirada na força e no legado das mulheres da família Natal.',
};
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                A Natal Acessórios é mais do que uma marca de jóias; é a celebração de um legado...
                            </p>
