...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen py-8">
      <Helmet>
        <title>Carrinho ({items.length} {items.length === 1 ? 'item' : 'itens'}) - Bella Jóias</title>
        <meta name="description" content="Revise seus itens selecionados e finalize sua compra na Bella Jóias" />
      </Helmet>
